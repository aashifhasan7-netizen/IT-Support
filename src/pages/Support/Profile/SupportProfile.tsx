...
export default function SupportProfile() {
  ...
  const fields = [
    ...
    { label: 'Role', value: 'Support Engineer', icon: Shield },
  ...
  return (
    <AppLayout title="My Profile" breadcrumb="Support Engineer">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-semibold text-slate-900 truncate">
                      ...
                      {field.label === 'Account Status' && (
                        <span className="ml-1.5 inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-700">● Active</span>
                      )}
                    </p>
                  </div>
                </div>
